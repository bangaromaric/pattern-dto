...
public class UtilisateurSimpleDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UtilisateurSimpleDTO)) {
            return false;
        }

        UtilisateurSimpleDTO utilisateurDTO = (UtilisateurSimpleDTO) o;
        if (this.id == null) {
            return false;
        }
